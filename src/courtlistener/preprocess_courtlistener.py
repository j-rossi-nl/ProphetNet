...
preocess('courtlistener/original_data/opinions.txt', 'courtlistener/courtlistener_tokenized/test.src', keep_sep=False)
preocess('courtlistener/original_data/opinions.txt', 'courtlistener/courtlistener_tokenized/test.tgt', keep_sep=False)
