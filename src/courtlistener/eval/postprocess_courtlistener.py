...
parser.add_argument('--export-clean', type=str, help='Export the generated content after tokenization cleaning')
...
if args.export_clean is not None:
    with open(args.export_clean, 'w') as fout:
        for l in generated_list:
